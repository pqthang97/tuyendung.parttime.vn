              ...
              foreach($posts_array as $key => $post) {
                ...
                <div class="landing_area_of_activity_explanation_wrapper  <?php if($key === 0) echo 'selected'; ?>" data-area="area_<?php echo $key; ?>_<?php echo $category->term_id; ?>">
                    ...
                    <?php echo $post->post_content; ?><br />
                      <a class="landing_area_of_activity_explanation_button" href="#" onClick="window.location = '<?php echo get_site_url().'/areas-of-activity?template='.$post->ID; ?>'; return false;">Đăng tuyển <?php echo $post->post_title; ?></a>
                    </div>
                </div>
              <?php 
              }
